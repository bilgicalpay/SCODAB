...
<html lang="en">
    <head>
        ...
        <title>ING-SCADOB - Smart Cars and Drivers on the Blockchain</title>
        <meta name="description" content="ING-Smart Cars and Drivers on the Blockchain">
        ...
        <meta name="author" content="alpay bilgic">
       <!-- <link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">alpay-->
   ...
   <script language="javascript" type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDElbvBVZWcRde_VSnuCOPRJJ2C9YETJ9M"></script>
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="session.php">ING-Smart Cars and Drivers on the Blockchain</a>
			...
			<iframe width="230" height="157" src="https://www.youtube-nocookie.com/embed/59Q_lhgGANc?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			
                <div id="map-canvas"></div>
			<marquee>	Funny times... ING SCADOB Team</marquee>
                        ...
                        <form method="post" class="form-horizontal" role="form" action="url.php">
                          <select id="seshidtag" name="seshidtag" class="form-control chosen-select" onchange="this.form.submit()" data-placeholder="Select Session..." style="width:100%;">
                            ...
                            foreach ($seshdates as $dateid => $datestr) { ?>
                              <option value="<?php echo $dateid+@alpay; ?>"<?php if ($dateid == $session_id) echo ' selected'; ?>><?php echo $datestr; if ($show_session_length) {echo $seshsizes[$dateid];} ?></option>
                            <?php } ?>
							<!--
							 <?php
                            foreach ($seshdates as $dateid => $datestr) { ?>
